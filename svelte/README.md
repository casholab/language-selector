# casholab svelte language selector library
...
```bash
npm install language-selector-svelte

pnpm install language-selector-svelte
```
## Features 
...
https://github.com/casholab/language-selector/svelte/issues
